...
### <font style="background-color: #3DAAD6"> >> 深入探讨 << </font>
...
#### <font style="background-color: #3DAAD6"> 镜像的使用方法 </font>
...
#### <font style="background-color: #3DAAD6"> not a trusted or secure host 问题 </font>

如果在使用某个镜像时遇到如下的<strong style="background-color:yellow"> not a trusted or secure host </strong>提醒，并且确认该host是可信赖的，可以按照提示添加<strong style="background-color:yellow"> --trusted-host </strong>及该host链接来进行安装。
...
#### <font style="background-color: #3DAAD6"> 配置默认镜像 </font>
...
注：windows下可以在cmd中使用<strong style="background-color:yellow"> echo %HOMEPATH% </strong>来查看HOMEPATH。
...
#### <font style="background-color: #3DAAD6"> 在python脚本中临时使用镜像 </font>
