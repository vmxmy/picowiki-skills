...
建议安装<a href="http://www.continuum.io/downloads" target="_blank">Anaconda</a>，一次安装包括了Python环境和全部依赖包，减少问题出现的几率。 各平台的安装方法请参考：<a href="https://tushare.pro/document/1?doc_id=29">Anaconda安装教程</a>