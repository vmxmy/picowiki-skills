---
name: mptext-api
description: WeChat public account article exporter API integration. Use whenever the user wants to search accounts, fetch article lists, download article content (html/markdown/text/json), or query account metadata via the mptext.top API. Triggers on: "公众号", "微信文章", "mptext", "下载文章", "搜索公众号", "文章导出", "WeChat article", "公众号查询".
---
